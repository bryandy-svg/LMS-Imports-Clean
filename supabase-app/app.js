...
const tableMap = {
  ...
  users: { table: "app_profiles", key: "username", title: "Users", sub: "Create users and restrict access by module.", heads: ["username", "full_name", "role", "modules"], labels: ["Username", "Name", "Role", "Modules"] },
...
function bindRows() {
  document.querySelectorAll("[data-edit]").forEach((b) => b.onclick = () => openModal(currentRows.find((r) => String(r[currentCfg.key] || r.id) === b.dataset.edit)));
